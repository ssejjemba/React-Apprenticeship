...
Feel free to take a look at `examples/hook-flow.png` if you're interested in
...
in which they're called, then open up `examples/hook-flow.png` and
`examples/hook-flow.js`. Play around with that a bit and hopefully that will
